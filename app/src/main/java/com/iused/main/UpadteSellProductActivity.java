...
/**
 * Created by Antto on 03/12/2016.
 */
public class UpadteSellProductActivity extends AppCompatActivity implements AsyncTaskListener{
...
//    Handler handler = new Handler();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressDialog= new ProgressDialog(UpadteSellProductActivity.this);
...
//        });
        ...
        edt_used_for_type.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(UpadteSellProductActivity.this);
    ...
    private void marshmellowPermissionStorage_video() {
        ...
        if (ContextCompat.checkSelfPermission(UpadteSellProductActivity.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(UpadteSellProductActivity.this,
...
//        buildDialog();
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(UpadteSellProductActivity.this);
...
//                    public void run(){
        ...
        new HotelierUploadGalleryImgs(UpadteSellProductActivity.this, picture_path_trimmed_camera,mCurrentPhotoPath).execute();
...
//            }
            ...
            if (resultCode == Activity.RESULT_OK){
                ...
                try {
                    ...
                    String tempPath = getPath(selectedImageUri, UpadteSellProductActivity.this);
...
//                image_uris.add("https://s3-us-west-2.amazonaws.com/mymarketbucket/"+picture_path_trimmed);
                    ...
                    new HotelierUploadGalleryImgs(UpadteSellProductActivity.this, picture_path_trimmed,tempPath).execute();
