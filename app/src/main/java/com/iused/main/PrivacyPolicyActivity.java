 ...
 */
public class PrivacyPolicyActivity extends AppCompatActivity implements AsyncTaskListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listener = PrivacyPolicyActivity.this;
...
//                        if(jsonObject.getString("errFlag").equalsIgnoreCase("Success")){
                        ...
                        if(object!=null){
                                txt_terms.setText(Html.fromHtml(object.getString("Privacy")));
//                                Log.e("terms",object.getString("Terms"));

//                            CharSequence trimmed = trimTrailingWhitespace(Html.fromHtml(object.getString("Privacy"), null, new MyTagHandler()));
//                            txt_terms.setText(trimmed);
                            webview_terms.loadData(object.getString("Privacy"),"text/html", "UTF-8");
                        }
