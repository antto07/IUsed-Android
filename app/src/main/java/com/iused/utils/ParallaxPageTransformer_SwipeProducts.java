...
public class ParallaxPageTransformer_SwipeProducts implements ViewPager.PageTransformer {

    private List<ParallaxTransformInformation> mViewsToParallax
            = new ArrayList<ParallaxTransformInformation>();

    public ParallaxPageTransformer_SwipeProducts() {
    }

    public ParallaxPageTransformer_SwipeProducts(List<ParallaxTransformInformation> viewsToParallax) {
        mViewsToParallax = viewsToParallax;
    }

    public ParallaxPageTransformer_SwipeProducts addViewToParallax(
