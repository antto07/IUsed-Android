 ...
 */
public class ProductMainAdapterNonNegotiable extends RecyclerView.Adapter<ProductMainAdapterNonNegotiable.CustomViewHolder>{
    ...
    public ProductMainAdapterNonNegotiable(Context context, ArrayList<MainProductsBean> mainProductsBeanCategories) {
    ...
    @Override
    public ProductMainAdapterNonNegotiable.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
//            Log.e("currency",str_currency_symbol);
    ...
    @Override
    public void onBindViewHolder(ProductMainAdapterNonNegotiable.CustomViewHolder holder, int position) {
